...
const fs = {
	access: u(mfs.access),
	appendFile: u(mfs.appendFile),
	appendFileSync: mfs.appendFileSync,
	chmod: u(mfs.chmod),
	chown: u(mfs.chown),
	close: u(mfs.close),
	...
	readlink: u(mfs.readlink),
	readlinkSync: mfs.readlinkSync,
	...
	promises: {
		...
		appendFile: mfs.promises.appendFile,
		...
		readlink: mfs.promises.readlink,
